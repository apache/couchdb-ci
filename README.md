...
```
NODEVERSION=20 ELIXIRVERSION=v1.18.4 ERLANGVERSION=26.2.5.20 ./build.sh platform debian-bookworm
```
...
where `<tag>` is of the format `<distro>-<version>-<type>`, such as `debian-bookworm-erlang-26.2.5.20`.
